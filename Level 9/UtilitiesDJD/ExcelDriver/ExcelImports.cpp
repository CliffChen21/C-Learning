...
#import "C:\Program Files\Microsoft Office\root\Office16\EXCEL.EXE" no_auto_exclude rename("DialogBox", "DialogBoxXL") rename("RGB", "RGBXL") rename("DocumentProperties", "DocumentPropertiesXL") rename("ReplaceText", "ReplaceTextXL") rename("CopyFile", "CopyFileXL") no_dual_interfaces
