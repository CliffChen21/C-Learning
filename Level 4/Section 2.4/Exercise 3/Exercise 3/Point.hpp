...
// 2021-07-18 CC Add single-value constructor and improve it to explicit declaration.
...
public:
	...
	explicit Point(double val); // Constructor accepts one value to both x and y.
	~Point(); // Destructor
...
ostream& operator << (ostream& os, const Point& p); // Global << operator function for Point description.
