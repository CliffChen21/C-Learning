...
// 2021-07-18 CC Add single-value constructor and improve it to explicit declaration in Point.hpp
...
// Constructor accepts one value for both x-/y- coordinates.
Point::Point(double val) : x(val), y(val) // colon syntax.
{
}
